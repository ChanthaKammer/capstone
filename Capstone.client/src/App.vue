<template>
  ...
  <footer class="row bg-black g-0 footy" style="width: 100%;">
    <marquee behavior="scroll" direction="right" scrollamount="10" class="text-light" style="width: 100vw; font-size: 2rem; font-weight: 650; font-style: italic;">
      ...
      <!-- <img src="https://media4.giphy.com/media/t9bA6dUJtVMvxcaxiR/giphy.gif?cid=6c09b952zg1nzgc3qt58h2illxu7lkpbsn89s7f90gqxtdjh&ep=v1_internal_gif_by_id&rid=giphy.gif&ct=s" class="img-fluid" style="max-height: 80px; margin-top" alt="mario"> -->
